                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-e8dd665811e955706c4ba328eb9a1085"' : 'data-target="#xs-components-links-module-AppModule-e8dd665811e955706c4ba328eb9a1085"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-e8dd665811e955706c4ba328eb9a1085"' :
                                            'id="xs-components-links-module-AppModule-e8dd665811e955706c4ba328eb9a1085"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/LearnComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">LearnComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ThanksComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ThanksComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
